...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "aws-sdk-core", "~> 3.66.0"
  spec.add_dependency "aws-sdk-iam", "~> 1.29.0"
  spec.add_dependency "aws-sdk-organizations", "~> 1.32.0"
  spec.add_dependency "aws-sdk-s3", "~> 1.48.0"
  spec.add_dependency "aws-sdk-ssm", "~> 1.55.0"
  spec.add_dependency "aws-sdk-ecr", "~> 1.20.0"
  spec.add_dependency "aws-sdk-ecs", "~> 1.49.0"

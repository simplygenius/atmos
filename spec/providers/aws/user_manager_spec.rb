...
describe Atmos::Providers::Aws::UserManager do
  ...
  describe "create_user" do
    ...
    it "creates a user" do
      ...
      expect(Atmos::Logging.contents).to match(/Creating new user/)
    end

    it "proceeds with existing user" do
      user = manager.create_user("foo@bar.com")
      expect(user).to match(hash_including(user_name: "foo@bar.com"))
      expect(Atmos::Logging.contents).to match(/already exists/)
    end
  ...
  describe "enable_login" do
    ...
    it "enables login" do
      ...
      expect(Atmos::Logging.contents).to_not match(/already exists/)
      expect(Atmos::Logging.contents).to match(/User login enabled/)
    end
    ...
    it "does nothing if exists and not force" do
      ...
      expect(Atmos::Logging.contents).to match(/already exists/)
      expect(Atmos::Logging.contents).to_not match(/Updated user/)
    end
    ...
    it "updates login if exists and force" do
      ...
      expect(user).to match(hash_including(password: anything))
      expect(Atmos::Logging.contents).to match(/already exists/)
      expect(Atmos::Logging.contents).to match(/Updated user/)
    end
  ...
  describe "enable_mfa" do
    ...
    it "enables mfa" do
      ...
      expect(Atmos::Logging.contents).to_not match(/already exist/)
    end
    ...
    it "does nothing if exists and not force" do
      ...
      expect(Atmos::Logging.contents).to match(/already exist/)
      expect(Atmos::Logging.contents).to_not match(/Deleting old mfa devices/)
    end
    ...
    it "updates if exists and force" do
      ...
      expect(user).to match(hash_including(mfa_secret: anything))
      expect(Atmos::Logging.contents).to match(/Deleting old mfa devices/)
      expect(Atmos::Logging.contents).to match(/already exist/)
    end
  ...
  describe "enable_access_keys" do
    ...
    it "updates if exists and force" do
      ...
      expect(user).to match(hash_including(key: anything, secret: anything))
      expect(Atmos::Logging.contents).to match(/Deleting old access keys/)
      expect(Atmos::Logging.contents).to match(/already exist/)
    end
  ...
  describe "set_public_key" do
    ...
    it "updates if exists and force" do
      ...
      expect(Atmos::Logging.contents).to match(/Deleting old ssh public keys/)
      expect(Atmos::Logging.contents).to match(/already exist/)
    end
  end
